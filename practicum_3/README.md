...
Після запуску локального сервера сторінка коректно відображає дані. Завдяки поліморфізму базові номери та конференц-зали обробляються в єдиному циклі, але виводять різну інформацію.
